  ...
  const inputTypes = [
    {
      ...
      icon: ImageIcon,
      title: 'Single Image',
      desc: 'Optical or multispectral satellite acquisition reference.',
      bands: 'RGB, NIR, RedEdge, SWIR, high-resolution optical bands',
    },
    {
      id: 'pair-sar',
      icon: Layers,
      title: 'Optical + SAR Pair',
      desc: 'Aligned Optical RGB & SAR Radar imagery for OpenEarthMap-SAR multimodal segmentation.',
      bands: '3-band RGB optical stream + 1-band SAR (VV/VH) radar backscatter stream',
    },
    {
      id: 'bitemporal',
      icon: Clock,
      title: 'Bi-temporal Pair',
      desc: 'Two temporal images (T1 & T2) of the same area for ChangeFormer change detection.',
